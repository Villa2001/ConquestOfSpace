...
public class Panel3 extends JPanel implements KeyListener{
    ...
    public void paintComponent(Graphics g){
      ...
      // g.drawImage(meteoro1.getImage(), Inicio x, Inicio y, limite en x, Limite y, posicion, posicion, tamaño en x ,Tamaño y, this);
        ...
        //------------------------------------------------------------------
          ...
          meteoro12 = new ImageIcon(getClass().getResource("/recursos/Panel3/Imagenes/meteoro1.png")); 
    ...
    public void sonidoON(){
         ...
         sonido1 = java.applet.Applet.newAudioClip(getClass().getResource("/recursos/Panel3/sonido/sonido1.wav")); 
         sonido1.play();
