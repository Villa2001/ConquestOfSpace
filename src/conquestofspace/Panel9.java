...
public class Panel9 extends JPanel implements KeyListener{
...
private Timer movimiento4 = new Timer(50,new ActionListener(){
    ...
    public void paintComponent(Graphics g){
        ...
        fondo1 = new ImageIcon(getClass().getResource("/recursos/Panel9/Imagenes/fondo1.jpg")); 
        g.drawImage(fondo1.getImage(), WIDTH, HEIGHT, this);
        //----------------------NAVE1-----------------------------------
        nave1 = new ImageIcon(getClass().getResource("/recursos/Panel9/Imagenes/nave1.png")); 
        g.drawImage(nave1.getImage(), x1, y1,99, 75,  this);
        //------------------------------------------------------------------
        meteoro1 = new ImageIcon(getClass().getResource("/recursos/Panel9/Imagenes/meteoro1.png")); 
      ...
      // g.drawImage(meteoro1.getImage(), Inicio x, Inicio y, limite en x, Limite y, posicion, posicion, tamaño en x ,Tamaño y, this);
        ...
        //------------------------------------------------------------------
         ...
         meteoro2 = new ImageIcon(getClass().getResource("/recursos/Panel9/Imagenes/meteoro2.png")); 
        g.drawImage(meteoro2.getImage(), csx[1], csy[1], csx[1] + 101 , csy[1] + 101, px[1], py[1], 101 + px[1] , 101, this);
        //------------------------------------------------------------------
        
         meteoro3 = new ImageIcon(getClass().getResource("/recursos/Panel9/Imagenes/meteoro3.png")); 
        g.drawImage(meteoro3.getImage(), csx[2], csy[2], csx[2] + 19 , csy[2] +19, px[2], py[2], 19 + px[2] , 19, this);
        //------------------------------------------------------------------
        
         meteoro4 = new ImageIcon(getClass().getResource("/recursos/Panel9/Imagenes/meteoro4.png")); 
        g.drawImage(meteoro4.getImage(), csx[3], csy[3], csx[3] + 90 , csy[3] +85, px[3], py[3], 90 + px[3] , 85, this);
        //------------------------------------------------------------------
        
        meteoro5 = new ImageIcon(getClass().getResource("/recursos/Panel9/Imagenes/meteoro5.png")); 
        g.drawImage(meteoro5.getImage(), csx[4], csy[4], csx[4] + 98 , csy[4] +98, px[4], py[4], 98 + px[4] , 98, this);
        //------------------------------------------------------------------
        
        meteoro6 = new ImageIcon(getClass().getResource("/recursos/Panel9/Imagenes/meteoro6.png")); 
        g.drawImage(meteoro6.getImage(), csx[5], csy[5], csx[5] + 43 , csy[5] + 43, px[5], py[5], 43 + px[5] , 43, this);
                
        //------------------------------------------------------------------
        
        meteoro7 = new ImageIcon(getClass().getResource("/recursos/Panel9/Imagenes/meteoro7.png")); 
        g.drawImage(meteoro7.getImage(), csx[6], csy[6], csx[6] + 101 , csy[6] +101 , px[6], py[6], 101 + px[6] , 101, this);
        
        //------------------------------------------------------------------
        
        meteoro8 = new ImageIcon(getClass().getResource("/recursos/Panel9/Imagenes/meteoro8.png")); 
        g.drawImage(meteoro8.getImage(), csx[7], csy[7], csx[7] + 120 , csy[7] +120, px[7], py[7], 120 + px[7] , 120, this);
        //------------------------------------------------------------------
        
        meteoro9 = new ImageIcon(getClass().getResource("/recursos/Panel9/Imagenes/meteoro9.png")); 
        g.drawImage(meteoro9.getImage(), csx[8], csy[8], csx[8] + 89 , csy[8] +89, px[8], py[6], 89 + px[8] , 89, this);
        //------------------------------------------------------------------
        
        meteoro10 = new ImageIcon(getClass().getResource("/recursos/Panel9/Imagenes/meteoro10.png")); 
        g.drawImage(meteoro10.getImage(), csx[9], csy[9], csx[9] + 98 , csy[9] +98, px[9], py[9], 98 + px[9] , 98, this);
        //------------------------------------------------------------------
        
        meteoro11 = new ImageIcon(getClass().getResource("/recursos/Panel9/Imagenes/meteoro11.png")); 
        g.drawImage(meteoro11.getImage(), csx[10], csy[10], csx[10] + 28 , csy[10] +28, px[10], py[10], 28 + px[10] , 28, this);
        //------------------------------------------------------------------
        
          meteoro12 = new ImageIcon(getClass().getResource("/recursos/Panel9/Imagenes/meteoro1.png")); 
...
public  ActionListener acciones = new ActionListener(){
 ...
 public void sonidoON(){
         ...
         sonido1 = java.applet.Applet.newAudioClip(getClass().getResource("/recursos/Panel9/sonido/sonido1.wav")); 
         sonido1.play();
